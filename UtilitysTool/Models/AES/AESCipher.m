...
{
    NSString* cipherText = aesEncryptString(text, KEY);
    log(@"[AES][cipher] %@ -> %@",text,cipherText);
    return cipherText;
}
...
+ (NSString*) decryptedText:(NSString*)text
{
    ...
    NSString* decryptedText = aesDecryptString(text, KEY);
    log(@"[AES][decrypted] %@ -> %@",text,decryptedText);
